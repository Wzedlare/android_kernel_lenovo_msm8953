...
#Lenovo-sw weimh1 mod 2016-3-9 begin:del here
#KERNEL_HEADER_DEFCONFIG := $(strip $(KERNEL_HEADER_DEFCONFIG))
#ifeq ($(KERNEL_HEADER_DEFCONFIG),)
#KERNEL_HEADER_DEFCONFIG := $(KERNEL_DEFCONFIG)
#endif
#Lenovo-sw weimh1 mod 2016-3-9 end
...
$(KERNEL_CONFIG): $(KERNEL_OUT) $(TARGET_DEFCONFIG)
	$(call do-kernel-config,$(BUILD_ROOT_LOC)$(KERNEL_OUT),$@,$(TARGET_DEFCONFIG),$(TARGET_KERNEL_SOURCE),$(KERNEL_ARCH),$(KERNEL_CROSS_COMPILE),$(MAKE))
